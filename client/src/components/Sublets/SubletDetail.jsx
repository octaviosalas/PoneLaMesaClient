          ...
          {(onClose) => (
            <>
              ...
              <div className="flex flex-col justify-start items-start text-start ml-6">
                 ...
                 {subletDetailData.used === true ? <p className="text-green-800 font-medium text-sm">Este Sub Alquiler fue Utilizado</p> : <p className="text-zinc-600 font-medium text-sm">Este Sub Alquiler no fue utilizado</p>}
              </div>
              <ModalBody>
