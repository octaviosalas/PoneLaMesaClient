...
import QuestionBeforeReturn from './QuestionBeforeReturn';

const SubletsToReturnDetailList = ({washData, updateNumbers}) => {
     ...
     const getDataAndCreateTable = () => { 
        ...
        const modifiedColumnObjects = columnObjects.map(column => {
            ...
            cellRenderer: (cell) => { 
                ...
                return (
                   <QuestionBeforeReturn item={item} updateNumbers={updateNumbers}/>
                );
            },
            }) 
  ...
  return (
           <div className='flex flex-col items-center justify-center mt-12'>
                <div className='flex flex-col items-start justify-start w-full rounded-b-none ' >
                      <div className='h-12 items-center justify-start w-full flex bg-green-200  gap-10 rounded-t-lg rounded-b-none'>             
                              <p className='font-bold text-sm text-zinc-600 underline ml-2'>Cantidades de Articulos Sub Alquilados para Devolver</p>
                      </div>     
                      <input
              ...
              {data.length > 0 && columns.length > 0 ? 
                   <Table
                     ...
                     className="w-full mt-2 max-h-[650px] h-auto text-center  overflow-y-auto"
                   >
            ...
            <div className='mt-12'>
                <p className='font-medium text-zinc-600 font-sm 2xl:font-md'>En este momento, no hay articulos para devolver</p>
...
export default SubletsToReturnDetailList
